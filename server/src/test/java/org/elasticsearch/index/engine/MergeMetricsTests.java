...
public class MergeMetricsTests extends ESTestCase {
    ...
    public void testMarkMergeMetricsCarriesIndexMode() {
        ...
        Measurement millis = single(registry, InstrumentType.LONG_HISTOGRAM, MergeMetrics.MERGE_DURATION_HISTOGRAM);
        assertThat(millis.attributes(), equalTo(expected));
        assertThat(millis.getLong(), equalTo(tookMillis));
