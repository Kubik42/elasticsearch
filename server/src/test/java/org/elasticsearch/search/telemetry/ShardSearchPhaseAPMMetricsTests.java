...
public class ShardSearchPhaseAPMMetricsTests extends ESSingleNodeTestCase {
    ...
    public void testQueryPhaseFailure() {
        ...
        assertFailureMeasurements(failures, e);
    ...
    private static void assertFailureMeasurements(List<Measurement> failures, SearchPhaseExecutionException e) {
        assertThat(failures, hasSize(e.shardFailures().length));
