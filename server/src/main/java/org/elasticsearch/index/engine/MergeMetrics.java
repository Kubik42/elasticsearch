...
public class MergeMetrics {
    ...
    public static final String MERGE_DURATION_HISTOGRAM = "es.merge.duration.histogram";
    ...
    private final LongHistogram mergeDurationInMillis;
    ...
    public MergeMetrics(MeterRegistry meterRegistry) {
        ...
        mergeDurationInMillis = meterRegistry.registerLongHistogram(MERGE_DURATION_HISTOGRAM, "Merge time in milliseconds", "ms");
        mergeFailures = meterRegistry.registerLongCounter(MERGE_FAILURE_TOTAL, "Number of merges that failed or were aborted", "unit");
        meterRegistry.registerLongAsyncGauge(
    ...
    public void markMergeMetrics(MergePolicy.OneMerge currentMerge, long mergedSegmentSize, long tookMillis, IndexMode indexMode) {
        ...
        mergeDurationInMillis.record(tookMillis, attributes);
    }
