...
public interface SearchOperationListener {
     ...
     * @param e the failure
     */
    default void onFailedQueryPhase(SearchContext searchContext, Exception e) {}
     ...
     *
     * @see #onFailedQueryPhase(SearchContext, Exception)
     */
     ...
     * @param e the failure
     */
    default void onFailedFetchPhase(SearchContext searchContext, Exception e) {}
     ...
     *
     * @see #onFailedFetchPhase(SearchContext, Exception)
     */
     ...
     * @param e the failure
     */
    default void onFailedDfsPhase(SearchContext searchContext, Exception e) {}
